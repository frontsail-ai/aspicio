...
import { AspicioEmbed as AspicioEmbedElement } from "@aspicio/elements";
...
const EmbedElement = createComponent({
  ...
  elementClass: AspicioEmbedElement,
  react: React,
  events: {
 ...
 *
 * The forwarded ref (and onViewer) still expose the full DrawingViewer for
 * camera control; use AspicioPreview + AspicioLayerPanel directly when you need
 * a custom layout.
 */
export const AspicioEmbed = forwardRef<DrawingViewer | null, AspicioEmbedProps>(
  function AspicioEmbed(
    {
      panel = "left",
    ...
    const elRef = useRef<AspicioEmbedElement | null>(null);
