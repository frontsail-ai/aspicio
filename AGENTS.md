...
apps/vue-example  real Vue embed integration + its e2e suite
apps/svelte-example  real Svelte embed integration + its e2e suite
apps/vanilla-example  hand-rolled UI on the raw core API + its e2e suite
apps/widget-example  MCP Apps widget showcase driven by a fake host + its e2e suite
...
| [docs/product-specs/vue.md](docs/product-specs/vue.md)                     | `VUE-*` — component behaviors                              | touching packages/vue or packages/elements                         |
| [docs/product-specs/svelte.md](docs/product-specs/svelte.md)               | `SVELTE-*` — component behaviors                           | touching packages/svelte or packages/elements                      |
